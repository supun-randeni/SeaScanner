...
def main():
    ...
    log_file = LogFile("Omniscan_logs", log_lock)
        ...
        while not shutdown_event.is_set():
            ...
            if sensor_enable_requested is False:
                ...
                if is_sensors_on is False:
                    ...
                    t1 = threading.Thread(
                        target=listen_to_sensor, args=(Omniscan_Left, "Sensor 1")
                    )
                    t2 = threading.Thread(
                        target=listen_to_sensor, args=(Omniscan_Right, "Sensor 2")
                    )
