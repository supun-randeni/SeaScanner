...
class Surveyor240(PingDevice):
    def __init__(self, logging = False, log_directory = None):
        super().__init__(payload_dict=definitions.payload_dict_surveyor240)
    ...
    def control_set_net_info(self, ntp_ip_address, subnet_mask, gateway_ip):
        m = pingmessage.PingMessage(definitions.SURVEYOR240_SET_NET_INFO,payload_dict=definitions.payload_dict_surveyor240)
    ...
    def control_set_ping_parameters(self, start_mm=0, end_mm=5000, sos_mps=1500, gain_index=-1, msec_per_ping=100, deprecated=0, diagnostic_injected_signal=0, ping_enable=False, enable_channel_data=False, reserved_for_raw_data=False, enable_yz_point_data=False, enable_atof_data=False, target_ping_hz=240000, n_range_steps=400, reserved=0, pulse_len_steps=1.5):
        m = pingmessage.PingMessage(definitions.SURVEYOR240_SET_PING_PARAMETERS,payload_dict=definitions.payload_dict_surveyor240)
        m.start_mm = start_mm
        m.end_mm = end_mm
        m.sos_mps = sos_mps
    ...
    def control_utc_response(self, utc_msec, accuracy_msec):
        m = pingmessage.PingMessage(definitions.SURVEYOR240_UTC_RESPONSE,payload_dict=definitions.payload_dict_surveyor240)
        m.utc_msec = utc_msec
    ...
    def read_packet(file):
        ...
        return pingmessage.PingMessage(msg_data=msg_bytes,payload_dict=definitions.payload_dict_surveyor240)
    ...
    def build_metadata_packet(self):
        ...
        m = pingmessage.PingMessage(definitions.OMNISCAN450_JSON_WRAPPER,payload_dict=definitions.payload_dict_surveyor240)
    ...
    def handle_message(self, msg):
        if msg.message_id == definitions.SURVEYOR240_UTC_REQUEST:
            ...
            response = pingmessage.PingMessage(definitions.SURVEYOR240_UTC_RESPONSE,payload_dict=definitions.payload_dict_surveyor240)
